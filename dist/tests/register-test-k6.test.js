...
// src/tests/register-test-k6.test.ts
...
var registeringAccount = new ScenarioConfig("iterating-registration").usePerVUIterations(5, 5).setExec("registerTestK6Test");
var options = new K6Config().addScenario(registeringAccount).build();
function registerTestK6Test() {
